...
def authenticated(function):
    ...
    def decorator(*args, **kwargs):
        ...
        # NOTE: this doesn’t seem to have much of a great impact, since we are using the collection value to authenticate the user, but it seems like a logical reason to check if the user did pass by the normal process of signin-in to have a valid session
